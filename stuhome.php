...
$enc =base64_decode($res['passtud']);
 echo "<form method='POST' action='stuhome.php'  enctype='multipart/form-data' >
        ...
        Password:<input type='text' minlength='8' name='pass' value='$enc' />
  ...
  /*  $p=date("Y/m/d");
    ...
    while ($row=mysql_fetch_array($q1)){
           ...
           if(!empty($arr1) && !empty($arr2))
           {
            ...
            $q2=mysql_query("SELECT   userstud from studreg where id in (".implode(",",$arr1).")   or id in (".implode(",",$arr2).") ");
