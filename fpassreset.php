...
<body>
   ...
   <h3  class="well"  style="margin-top:-10%;margin-left:10%;width:80%;background-color:white;" >  <button class="btn btn-info pull-left " name="sea" ><span class="glyphicon glyphicon-Home"></span><a href="index.php">Home </a> </button> Reset Password  </h3>
     <div class="form-group" >
      ...
      <tr>
        <td > <input type="password"   minlength="8"  maxlength="8"  class="form-control" name="pass" placeholder="Password" /></td>
      </tr>
      <tr>
        <td   ><input type="password"  minlength="8" maxlength="8" class="form-control"  name="repass" placeholder="ReEnter Password" /> </td>
      </tr>
      <tr>
        <td>
...
if(isset($_REQUEST['upbtn']))
{
    ...
    $pass=$_POST['pass'];
    $repass=$_POST['repass'];
    $fpass=base64_encode($_POST['pass']);
    ...
    $u=$_GET['id1'];
      ...
      $fec=mysql_query("SELECT  *  from facreg where  userfac ='$u' ");
   ...
   $up=mysql_query("update facreg set password='$fpass' where userfac='$u'");
