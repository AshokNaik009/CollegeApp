   ...
   <h3  class="well"  style="margin-top:-10%;margin-left:10%;width:80%;background-color:white;" >  <button class="btn btn-info pull-left " name="sea" ><span class="glyphicon glyphicon-Home">   </span> <a href='index.php' style="text-decoration: none">Home </a> </button>  Change Password  </h3>
     <div class="form-group" >
      ...
      <tr>
        ...
        <td  cellsapcing="10" ><input type="text" class="form-control"  name="uname" placeholder="UserName:" /> </td>
      </tr>
      <tr>
...
if(isset($_POST['chan']))
{
  ...
  $u=$_POST['uname'];
   ...
   $query=mysql_query("Select DOB,userfac,email from facreg where DOB='$dob' and userfac='$u' and email='$mail'  ");
   ...
   if(mysql_num_rows($query)>0)
   {
        ...
        echo  "<a href='fpassreset.php?id1={$row['userfac']}' ?>Click Here to Change Your Password </a>";
